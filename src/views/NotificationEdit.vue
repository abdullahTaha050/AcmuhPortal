<template>
  <div class="container">
    <div class="d-flex justify-content-center pt-5">
      ...
      <div class="row">
        <div class="col-md-8">
          <form @submit.prevent="updateNotice" enctype="multipart/form-data">
            <div class="mt-5">
              <h2 class="text-center p-2">Duyuruyu Düzenle</h2>
        ...
        <div class="col-md-4 pt-5">
          <img :src="'https://localhost:44346/api/notice/image?filename='+this.imagePath"
  ...
  methods : {
    ...
    async updateNotice(){
      ...
      await this.$axios.patch(this.$apiUrl + endPoint , formData,
          ...
          .then(response => {
              this.$toast("Duyuru başarıyla güncellendi.", {
                timeout: 3000,
    ...
    async getNotificationData(){
      let endPoint = 'Notice/getbyid?id='+this.$route.params.id;
      await this.$axios.get(this.$apiUrl + endPoint,
          ...
          .then(response => {
            ...
            if (this.imagePath !== ""){
              let imageEndPoint = 'Notice/image?filename='+this.imagePath;
